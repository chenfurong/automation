...
<script language="javascript" type="text/javascript">
	...
	function checkSelect() {
		...
		if (infoId.length == 0) {
			...
			location.href = "getInstanceDetial?serId=" + infoId + "&ptype=osagent";
		}
	}
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<a href="#" title="IBM OS Agent" class="tip-bottom">IBM OS Agent</a>
		</div>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="columnfoot">
						<a class="btn btn-info fr btn-next" onclick="checkSelect();">
