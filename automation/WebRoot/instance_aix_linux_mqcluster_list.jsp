...
<script language="javascript" type="text/javascript">
	...
	function checkMQSelect() {
		...
		if (infoId.length == 0) {
			...
			location.href = "getInstanceDetial?serId=" + infoId + "&ptype=mqcluster";
		}
	}
						...
						for ( var key in jsonstr[i]) 
						{
							...
							else if (key == 'Status') 
							{
								if (jsonstr[i][key] == 'Active')
									ht = ht + '<td style="text-align: center;" name="state"><img src="img/icon_success.png"></img>&nbsp;&nbsp;<b>Active</b></td>';
								if (jsonstr[i][key] == 'Error')
									ht = ht + '<td style="text-align: center;" name="state"><img src="img/icon_error.png"></img>&nbsp;&nbsp;<b>Error</b></td>';
							} 
							else if (key == 'edit') 
							{
								ht = ht + '<td style="text-align: center;"><img src="img/edit.png" id="postsubmit" name="postsubmit"   onmousedown="old=this.src; this.src="img/edit18.png";onmouseup="this.src=old;" onclick="editHost(this);"/></td>';
							} 
							else 
							{
...
<script>
	...
	function editHost(obj) {
		var _id = $(obj).parent().parent().prev().prev().prev().prev().prev()
				        .prev().find('div').find('span').find('div').find('span').find('input').val(); //_id
		$.ajax({
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<a href="#" title="IBM MQCluster" class="tip-bottom">IBM MQCluster</a>
		</div>
				...
				<div class="span12">
					<div class="widget-box collapsible">
						...
						<div id="collapseOne" class="collapse in">
							<div class="widget-content">所有MQ Cluster实例信息.</div>
						</div>
					</div>
				</div>
			</div>
									...
									<c:forEach items="${servers }" var="ser">
										<tr>
											<td style="text-align: center;">
											   <input type="checkbox" name="servers" value="${ser._id }" onclick="isSelect(this);" />
											</td>
