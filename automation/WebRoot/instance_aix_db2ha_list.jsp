	...
	<script type="text/javascript">
		...
		function checkDB2Select() 
	    {
			...
			if(infoId.length >= 0 && infoId.length < 2){
				...
				location.href = "getInstanceDetial?serId="+infoId  +"&ptype=DB2HA";
			}
            ...
            <div class="widget-box collapsible">
                <div class="widget-title">
                  ...
                  <div id="collapseOne" class="collapse in">
                      <div class="widget-content">所有DB2HA可用虚机实例信息.</div>
                  </div>
              </div>
          </div>
    </div>
                    ...
                    <table name="data-table"
								...
								<tbody class="searchable">
									...
									<c:forEach items="${servers }" var="ser">
										<tr>
											<td style="text-align: center;">
													<input type="checkbox" name="servers" value="${ser._id }"
														onclick="isSelect(this);" />
												</td>
