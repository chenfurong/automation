...
<script type="text/javascript">
	...
	function checkDB2Select() {
		...
		if (infoId.length == 0) {
			...
			location.href = "toDb2NextPage?serId=" + infoId + "&status=makevg"
					+ "&ptype=DB2";
		}
	}
											...
											$
													.ajax({
														...
														success : function(
															...
															$('table tbody')
																	.html(ht);
															$('table tbody').attr('class','table data-table table-striped table-bordered table-hover');
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<a href="#" title="IBM DB2" class="tip-bottom">IBM DB2</a>
		</div>
				...
				<div class="span12">
					...
					<div class="columnfoot">
						<a class="btn btn-info fr btn-next" onclick="checkDB2Select();">
							<span>开始创建</span> <i class="icon-btn-next"></i>
						</a>
					</div>
				</div>
			</div>
